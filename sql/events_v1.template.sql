...
WITH events AS (
  ...
  SELECT
    ...
    error_message,
    is_truncated,
    COALESCE(CAST(JSON_VALUE(usage_metadata, '$.prompt_token_count') AS INT64), usage_prompt_tokens) AS usage_prompt_tokens,
    COALESCE(CAST(JSON_VALUE(usage_metadata, '$.candidates_token_count') AS INT64), usage_completion_tokens) AS usage_completion_tokens,
    COALESCE(CAST(JSON_VALUE(usage_metadata, '$.total_token_count') AS INT64), usage_total_tokens) AS usage_total_tokens,
